Pod::Spec.new do |s|
  s.name             = 'IssueReportingPackageSupport'
  s.version          = '1.4.2'
  s.summary          = 'Package support for Issue Reporting in XCTestDynamicOverlay'
  ...
  s.source_files = 'Sources/IssueReportingPackageSupport/**/*.swift'
  s.module_name = 'IssueReportingPackageSupport'
